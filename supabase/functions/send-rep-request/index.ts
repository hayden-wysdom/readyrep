...
serve(async (req) => {
  ...
  try {
    ...
    if (!fullName || !email || !company || !deviceDescription) {
      return new Response(
    ...
    const res = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        reply_to: email,
        subject: `[DeviceWyze] Representative Request - ${company} - from ${fullName}`,
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <div style="background: #3B8EC4; padding: 20px; border-radius: 8px 8px 0 0;">
              <h1 style="color: white; margin: 0; font-size: 20px;">New Representative Request</h1>
            </div>
            <div style="border: 1px solid #e5e7eb; border-top: none; padding: 24px; border-radius: 0 0 8px 8px;">
              <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                  ...
                  <td style="padding: 8px 0; color: #111827; font-weight: 600;">${company}</td>
                </tr>
              </table>
            ...
            <p style="color: #9ca3af; font-size: 12px; text-align: center; margin-top: 16px;">
              Sent from DeviceWyze - Representative Request Form
            </p>
          </div>
        `,
      }),
